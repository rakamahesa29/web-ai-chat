...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | FrankenPHP Server Options
    |--------------------------------------------------------------------------
    |
    | Number of workers, max requests per worker before restart, and request
    | timeout. For SSE streaming, keep workers >= 2 and timeout >= 300.
    |
    */
    ...
    'frankenphp' => [
        ...
        'workers' => [
            'num' => env('OCTANE_WORKERS', 4),
            'max_requests' => env('OCTANE_MAX_REQUESTS', 500),
            'request_timeout' => env('OCTANE_REQUEST_TIMEOUT', 300),
        ],
        'https' => env('OCTANE_HTTPS', false),
