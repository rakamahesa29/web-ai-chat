...
class QueryClassifier
{
    ...
    private array $latestDataIndicators = [
        // Indonesian
        'terbaru', 'terkini', 'sekarang', 'hari ini', 'minggu ini', 'bulan ini', 'tahun ini',
        'update terbaru', 'versi terbaru', 'rilis terbaru', 'berita', 'kabar',
        'saat ini', 'baru-baru ini', 'belakangan ini', 'tren', 'trending',
        
        // English
        'latest', 'newest', 'recent', 'current', 'today', 'this week', 'this month', 'this year',
        'latest version', 'latest release', 'news', 'trending', 'update',
        'right now', 'currently', 'recently', 'new features', 'new update',
        '2024', '2025', '2026', '2027',
    ];
    ...
    public function classify(string $query, string $personaKey = 'general'): array
    {
        ...
        $isLatestData = $this->detectLatestDataQuery($queryLower);
