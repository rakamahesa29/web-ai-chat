...
class OllamaCloudAdapter implements BaseAdapter
{
    ...
    public function __construct(string $modelName)
    {
        ...
        $this->baseUrl = config('services.ollama_cloud.base_url', 'http://127.0.0.1:11434');
    }
    ...
    public function generateResponse(array $payload): \Generator|array
    {
        ...
        $requestPayload = [
            ...
            'stream' => true,
            'options' => [
                'temperature' => config('services.ollama_cloud.temperature', 0.60),
                'num_ctx' => config('services.ollama_cloud.context_length', 65536),
            ],
        ];
