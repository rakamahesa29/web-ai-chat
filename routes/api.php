...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/chat/messages/{message}/export-docx',          [ChatApiController::class, 'exportDocx']);
    Route::post('/chat/messages/{message}/export-google-docs',   [GoogleController::class, 'exportDocs']);
    Route::post('/chat/messages/{message}/export-google-sheets', [GoogleController::class, 'exportSheets']);
    ...
    // Room Skills (mirrors web routes but under Sanctum for mobile clients)
    Route::get('/chat/rooms/{room}/skills',                  [RoomSkillController::class, 'index']);
    Route::post('/chat/rooms/{room}/skills',                 [RoomSkillController::class, 'store']);
    Route::patch('/chat/rooms/{room}/skills/{skill}/toggle', [RoomSkillController::class, 'toggle']);
    Route::delete('/chat/rooms/{room}/skills/{skill}',       [RoomSkillController::class, 'destroy']);
